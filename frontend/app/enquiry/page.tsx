              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <motion.select
                    ...
                    className="mt-1 w-full px-4 py-3 rounded-lg  bg-gray-100/80 border border-pink-200/50 text-black cursor-not-allowed"
                    disabled
                  >
                ...
                <div>
                  ...
                  <motion.textarea
                    ...
                    className="mt-1 w-full px-4 py-3 rounded-lg bg-gray-100/80 border border-pink-200/50 text-black cursor-not-allowed resize-y"
                    rows={3}
                    readOnly
                  ></motion.textarea>
                </div>
